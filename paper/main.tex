...
sequences and $87{,}881$ for random sequences (to calibrate: a sequence of
...
is roughly $70\times$ below that floor, confirming near-minimal algorithmic
complexity for real instruction streams).
